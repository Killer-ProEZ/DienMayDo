...
{
	$IDSP = $_GET['IDSP'];
	$SLHang = pg_query($Connect,"SELECT SP_SoLuong FROM public.sanpham WHERE SP_Ma = $IDSP");
	...
	if($RowSLHang[0] >= 1)
	{
		...
		if(!$DaCo)
		{
			$SPChiTiet = pg_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM public.hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten, c.LSP_Ma, NSX_Ten FROM public.sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma JOIN nhasanxuat d ON a.NSX_Ma = d.NSX_Ma WHERE SP_Ma = '$IDSP'");
						...
						<div class="products-tabs">
							...
							<div class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1">
									<!-- product -->
									<?php 
									$SanPham = pg_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM public.hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten, c.LSP_Ma FROM public.sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma WHERE SP_SoLuong>0");
						...
						<div class="products-tabs">
							...
							<div id="tab2" class="tab-pane fade in active">
								<div class="products-slick" data-nav="#slick-nav-2">
									<!-- product -->
									<?php 
									$SPBanChay = pg_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM public.hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten,(SELECT SUM(SP_DH_SoLuong) FROM public.sp_dondathang d WHERE a.SP_Ma = d.SP_Ma) AS SoLuong FROM public.sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma ORDER BY SoLuong DESC LIMIT 0,4");
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="products-widget-slick" data-nav="#slick-nav-3">
						<div>
							<!-- product widget -->
							<?php 
							$TopLapTop = pg_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM public.hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten,(SELECT SUM(SP_DH_SoLuong) FROM public.sp_dondathang d WHERE a.SP_Ma = d.SP_Ma) AS SoLuong FROM sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma WHERE a.LSP_Ma = 1 ORDER BY SoLuong DESC LIMIT 0,3");
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="products-widget-slick" data-nav="#slick-nav-4">
						<div>
							<!-- product widget -->
							<?php 
							$TopCamera = mysqli_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten,(SELECT SUM(SP_DH_SoLuong) FROM public.sp_dondathang d WHERE a.SP_Ma = d.SP_Ma) AS SoLuong FROM public.sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma WHERE a.LSP_Ma = 2 ORDER BY SoLuong DESC LIMIT 0,3");
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="products-widget-slick" data-nav="#slick-nav-5">
						<div>
							<!-- product widget -->
							<?php 
							$TopPhone = pg_query($Connect,"SELECT a.*,(SELECT b.HSP_TenTapTin FROM public.hinhsanpham b WHERE a.SP_Ma = b.SP_Ma ORDER BY HSP_TenTapTin LIMIT 0,1) AS AvatarSP, LSP_Ten,(SELECT SUM(SP_DH_SoLuong) FROM public.sp_dondathang d WHERE a.SP_Ma = d.SP_Ma) AS SoLuong FROM public.sanpham a JOIN loaisanpham c ON a.LSP_Ma = c.LSP_Ma WHERE a.LSP_Ma = 3 ORDER BY SoLuong DESC LIMIT 0,3");
