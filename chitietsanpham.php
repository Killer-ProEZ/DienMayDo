			...
			<div class="row">
				...
				<div class="col-md-5 col-md-push-2">
					<div id="product-main-img">
						<?php
						$AnhMain = pg_query($Connect, "SELECT hsp_tentaptin FROM public.hinhsanpham WHERE sp_ma = '$IDSP'");
				...
				<div class="col-md-5">
					<?php
					$SPChiTiet = pg_query($Connect, "SELECT SP_Ma, LSP_Ten, a.LSP_Ma, NSX_Ten, SP_Ten, SP_GiaHienTai, SP_GiaCu, SP_MoTa, SP_MoTa_ChiTiet, SP_SoLuong FROM public.sanpham a JOIN loaisanpham b ON a.LSP_Ma = b.LSP_Ma JOIN nhasanxuat c ON a.NSX_Ma = c.NSX_Ma WHERE SP_Ma = '$IDSP'");
					...
					?>
						<div class="product-details">
							...
							<div>
								...
								<span class="product-available"><?php if ($RowSPChiTiet['SP_SoLuong'] <= 0) {
																	echo "<font color='black'>Hết Hàng</font>";
																} else echo "Còn Hàng"; ?></span>
							</div>
							...
							<ul class="product-links">
								<li>Loại: </li>
								<li><a href="?ID=<?php if ($RowSPChiTiet['LSP_Ma'] == 1) {
														echo "Laptop";
													} else if ($RowSPChiTiet['LSP_Ma'] == 2) {
														echo "Mayanh";
													} else echo "Dienthoai"; ?>"><?php echo $RowSPChiTiet['LSP_Ten']; ?></a></li>
								<li>Nhà Sản Xuất: </li>
								<li><a href="?ID=<?php if ($RowSPChiTiet['LSP_Ma'] == 1) {
														echo "Laptop";
													} else if ($RowSPChiTiet['LSP_Ma'] == 2) {
														echo "Mayanh";
													} else echo "Dienthoai"; ?>"><?php echo $RowSPChiTiet['NSX_Ten']; ?></a></li>
							</ul>
