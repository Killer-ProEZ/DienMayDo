						...
						<div class="header-ctn">
							...
							<div class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
									...
									<span>Yêu Thích</span>
									<div class="qty"><?php if (isset($_SESSION['YeuThich']) && count($_SESSION['YeuThich']) > 0) echo count($_SESSION['YeuThich']);
														else echo ''; ?></div>
								</a>
							...
							<div class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
									...
									<span>Giỏ Hàng</span>
									<div class="qty"><?php if (isset($_SESSION['GioHang']) && count($_SESSION['GioHang']) > 0) echo count($_SESSION['GioHang']);
														else echo ''; ?></div>
								</a>
								<div class="cart-dropdown">
									<div class="cart-list">
									...
									<div class="cart-summary">
										<small><?php if (isset($_SESSION['GioHang']) && count($_SESSION['GioHang']) > 0) echo count($_SESSION['GioHang']);
												else echo ''; ?> Item(s) được chọn</small>
									...
									<div class="cart-btns">
										...
										<a href="<?php if (isset($_SESSION['TaiKhoan'])) {
														echo "?ID=Thanhtoan";
													} else echo "?ID=dangnhap";  ?>">Thanh Toán<i class="fa fa-arrow-circle-right"></i></a>
									</div>
								</div>
							</div>
							<!-- /Cart -->
				...
				<ul class="main-nav nav navbar-nav">
					...
					?>
						<li><a href="?ID=<?php if ($RowMenu['lsp_ma'] == 1) {
												echo 'Laptop';
											} else if ($RowMenu['lsp_ma'] == 2) {
												echo 'Mayanh';
											} else echo 'Dienthoai'; ?>"><?php echo $RowMenu['lsp_ten']; ?></a></li>
					<?php
					}
					?>
				</ul>
